...
var Kidney = /** @class */ (function () {
    function Kidney(api, router, activatedRoute, seoService) {
        var _this = this;
        this.api = api;
        this.router = router;
